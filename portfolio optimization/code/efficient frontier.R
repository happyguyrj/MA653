...
# Assign to dataframe
# Get adjusted prices
prices.data <- merge.zoo(aapl.close ,amd.close,goog.close,amzn.close,nflx.close)
...
# Set names
colnames(returns.data) <- c("aapl","amd","goog","amzn","nflx")
...
#names of the assets
port <- portfolio.spec(assets = c("aapl","amd","goog","amzn","nflx"))
